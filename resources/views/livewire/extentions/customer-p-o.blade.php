            ...
            <div class="d1cc">
                    ...
                    <div class="separatorz">
                     ...
                     <div class="field">
                        ...
                        <input type="number" onKeyPress="if(this.value.length==16) return false;" id="phones" wire:model="phone"  value="" style="@error('phone') border: 1px solid rgb(255, 80, 80); @enderror" >
    ...
    paypal.Buttons({ 
        ...
        onClick: function()  {
                ...
                ) 
            {
                ...
                @this.set('phone', document.getElementById('phones').value);
