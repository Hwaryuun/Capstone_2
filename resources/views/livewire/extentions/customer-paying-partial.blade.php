<section @if (count($carstats) != 0)  class="packagesxs" @else class="packagesxss" @endif id="package">
        ...
        <div class="d1ccc">
            ...
            <div class="separatorAB">
                <div class="dcontentbc">
                    <div class="field">
                        <p class="sumarrys00">{{$cart->Carts->ProductPricing->Products->name}}</p>                                                    
                    </div> 
                </div> 
                <div class="dcontentbc">
                    <div class="field">
                        <p class="sumarrys11">{{$cart->Carts->paperdefault}}</p> 
                        <p class="sumarrys11">{{$cart->Carts->cover}}</p>  
                        <p class="sumarrys11">{{$cart->Carts->ProductPricing->Size->length}} x {{$cart->Carts->ProductPricing->Size->width}}</p>               
                        @if ($cart->Carts->page)
                        <p class="sumarrys11">{{$cart->Carts->page}}. leaves</p>  
                        @endif
                        <p class="sumarrys11">{{$cart->Carts->quantity}}. pcs</p>  
                        <p class="sumarrys11"><a onclick="showie('{{$cart->Carts->files}}')"> My Design : <i class="fa-solid fa-pen-nib"></i> </a></p>                            
                    </div> 
                </div> 
                <div class="dcontentbc">
                    <div class="field">
                        <p class="sumarrys22">₱ : {{number_format((float)$cart->Carts->CartPrice->defaultprice, 2,".",",") }}</p>
                        @if ($cart->Carts->page)    
                        <p class="sumarrys22">₱ : {{number_format((float)$cart->Carts->CartPrice->coverprice, 2,".",",") }} </p> 
                        @endif        
                        <p class="sumarrys22">₱ : {{number_format((float)$cart->Carts->CartPrice->sizeprice, 2,".",",") }} </p>   
                        @if ($cart->Carts->page)    
                        <p class="sumarrys22">₱ : {{number_format((float)$cart->Carts->CartPrice->leafprice, 2,".",",") }} </p>
                        @endif       
                        <p class="sumarrys22"> {{$cart->Carts->CartPrice->quantity}} </p>   
            ...
            <div class="separatorA">
                <div class="dcontentbc">
                    <div class="field">
                        <p class="sumarrys00"> Sub-Total : </p>                            
                    </div> 
                </div> 
                <div class="dcontentbc">
                    <div class="field">
                        <p class="sumarrys22">₱ : {{number_format((float)$cart->price, 2,".",",") }}</p>                                                      
                    </div> 
                </div> 
            </div> 
            ...
            <div class="separatorA">
                <div class="dcontentb">
                    <div class="field">
                        <H3 class="sumarrys20"> Past Tracking ID : </H3>                            
                    </div> 
                </div> 
                <div class="dcontentb">
                    <div class="field">
                        <H3 class="sumarrys30"> {{$cart->Orders->tracking_no}}</H3>                                                      
                    </div> 
                </div> 
            </div> 
            <div class="separatorA">
                ...
                <div class="dcontentb">
                    <div class="field">
                        <H3 class="sumarrys21">₱ :  {{number_format((float)$carstats->sum('price'), 2,".",",") }}</H3>                                                      
                    </div> 
                </div> 
            </div> 
            <hr> 
        ...
        <div class="d1cc">
                ...
                <div class="separatorz">
                 ...
                 <div class="field">
                    ...
                    <textarea id="remarks" wire:model="remarks"> </textarea>
    ...
    @else
        <div class="d1cccc">
            ...
            <a href="{{Route('MyOrders')}}" class ="Add-ITMEX"> <i class="fa-solid fa-square-caret-left"></i> <span> Go Back </span></a>
        </div> 
    @endif
    ...
    paypal.Buttons({ 
      ...
      createOrder: (data, actions) => {
        return actions.order.create({
          purchase_units: [{
            amount: {
              value: '{{number_format((float)$carstats->sum('price'), 2, '.', '') }}'
            }
          }]
        });
      },
