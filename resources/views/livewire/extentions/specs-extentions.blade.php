<div>
    <!--Package section--->
           ...
           <div class="inps">
            ...
            <form action="{{Route('OrderSummary', $product_id)}}" method="POST" enctype="multipart/form-data">
                @method('GET')
                @csrf 
               ...
               <div class="BUTNS-ADS">
                  ...
                  <a  class ="Add-ITMC"  href="{{Route('SProducts', $prody->Category->id)}}"> <i class="fa-solid fa-caret-left"></i> <span> Go Back </span></a>
                  <button class ="Add-ITME" type="submit"> <i class="fa-solid fa-upload"></i> <span> Proceed To Upload</span></button>
            ...
            <div class="BUTNS-ADSX">
                 <a class="asasas" href="{{Route('ViewTemp', $product_id )}}" > <b style="color: #4f4f4f; margin-right: 10px "> No Design ? </b> View Templates First !</a>
            </div>
