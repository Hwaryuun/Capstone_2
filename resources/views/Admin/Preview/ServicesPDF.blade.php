...
<body>
    ...
    <table class="order-details">
        <thead>
            <tr>
                ...
                <th width="50%" colspan="4" class="text-end company-data">
                    <span>Type : Service Reports </span> <br>               
        ...
        <tbody>
            ...
            <tr>
                <td> <b> Total </b> </td>
                <td >  <b> PHP. {{ number_format((float)$daiki3->SUM('sales'), 2, ".",",") }}  </b>   </td>
                <td>  <b>  PHP.  {{ number_format((float)$daiki3->SUM('sales')  * .30 , 2, ".",",") }} </b> </td>
    ...
    <table class="order-details">
        ...
        <tbody>
            ...
            <tr>
                <td> <b> Total </b> </td>
                <td ><b> PHP. {{ number_format((float)$daiki4->SUM('sales'), 2, ".",",") }}  </b>   </td>
                <td>  <b>  PHP.  {{ number_format((float)$daiki4->SUM('sales')  * .30 , 2, ".",",") }} </b> </td>
                <td > <b> {{now()->format('Y-m-d') }} </b>  </td>
    ...
    <table class="order-details">
        ...
        <tbody>
            ...
            <tr >
                ...
                <td style="border: 1px solid  #414ab1 " > PHP. {{ number_format((float)$daiki4->SUM('sales') + $daiki3->SUM('sales'), 2, ".",",") }}    </td>
                <td style="border: 1px solid  #414ab1 " > <b>  Total Revenue : </b>  </td>
                <td style="border: 1px solid  #414ab1 " >    PHP.  {{ number_format((float)($daiki4->SUM('sales') + $daiki3->SUM('sales') )* .30 , 2, ".",",") }}  </td>
