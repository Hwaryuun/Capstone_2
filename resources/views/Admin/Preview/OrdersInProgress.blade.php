            ...
            <div class="Table-1" >
                ...
                <div class="Table-con">
                    <div class="Cnt">
                        ...
                        <p class="DY">In-Progress-Orders</p>
                    </div>
                    <div class="Cnt2hX">   
                      <a href="{{route('Orders.index')}}" class="XYZ"  ><i class="fa-solid fa-file-circle-exclamation"></i></i> New-Order</a> 
                      <a  href="{{route('OrdersProgress')}}" class="XYZ"   id="lickus" style=" background-color: #f6b14b;"><i class="fa-solid fa-file-circle-minus"></i> In-Progess</a> 
                      <a  href="{{route('OrdersFinished')}}" class="XYZ" style=" background-color: #0ce150;"><i class="fa-solid fa-file-circle-check"></i></i> Finished </a>   
                    </div>
              ...
              <div class = " Table-Section-Main">
                <table id="Orders" class="display" style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        @if ($sumer->tracking_old != 'NO-OLD ORDER TRACKING')
                        <td>{{$sumer->tracking_old}}</td>
                        @else
