          ...
          <div class="Table-1" >
              ...
              <div class="Table-con">
                  ...
                  <div class="Cnt2hX">   
                    ...
                    <a  href="{{route('PartialProgress')}}" class="XYZ"  id="lickus"  style=" background-color: #f6b14b;"><i class="fa-solid fa-file-circle-minus"></i> In-Progess</a> 
                    <a  href="{{route('PartialFinished')}}" class="XYZ" style=" background-color: #0ce150;"><i class="fa-solid fa-file-circle-check"></i></i> Finished </a>   
                  </div>
