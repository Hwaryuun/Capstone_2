...
<div class="main">
         ...
         <div  class = "M-Table">
            ...
            <div class="Table-1" >
                ...
                <div class="Table-con">
                    <div class="Cnt">
                        <H3 class="ORP">Trasaction History : All History</H3>
                    ...
                    <div class="Cnt2hX">  
                        @can('Transac-create')
                        <a  href="{{route('PrintPdfrATRNS')}}" style="margin-right: 20px" class ="XYZ">  <i class="fa-solid fa-print"></i> <span> Print History </span></a> 
                        @endcan
                        <a href="{{route('Transac.index')}}" class="XYZ" style=" background-color: #0080af;" ><i class="fa-solid fa-file-circle-exclamation"></i></i> WEEKLY </a>                 
                        <a  href="{{route('monthlyindex')}}" class="XYZ" style=" background-color: #0080af;"><i class="fa-solid fa-file-circle-check"></i></i> MONTHLY </a>
                        <a  href="{{route('allhistoryindex')}}" class="XYZ"  id="lickus" style=" background-color: #008abc;" ><i class="fa-solid fa-file-circle-check"></i></i> ALL </a>    
                ...
                <table id="Design" class="display" style="width:100%">
                    ...
                    <tr>
                        ...
                        <td><p class="slayers" style="background-color: #3c71ec; color: white;">{{$sus->created_at->format('F j, Y')}} </p></td>
