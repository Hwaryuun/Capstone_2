    ...
    <div class="Add-Holder"> <!-- Add Holder------------------------------------>
        ...
        <div class="Add-InP"> <!-- Add Inp------------------------------------>
            ...
            <div class ="Mid-Form">  <!-- Mid Inp------------------------------------>
              ...
              <form action="{{Route('FeaturedNTemplates.store')}}" method="POST" enctype="multipart/form-data">
                 @csrf  
                ...
                <div class = "EXSepator"> <!-- Mid SEPERATOR------------------------------------>
                    ...
                    <div class = "S1"> <!-- Mid S1------------------------------------>
                        ...
                        <div class="field">
                            <label>Name</label>
                            <input type="text" name="name" placeholder="Example: CallingCard Featured D" value="{{old('name')}}" style="@error('name') border: 1px solid red; @enderror" >
