    ...
    <div class="main"> <!-- Main------------------------------------>
        ...
        <div class="Add-Holder"> <!-- Add Holder------------------------------------>
            ...
            <div class="Add-InP"> <!-- Add Inp------------------------------------>
                ...
                <div class ="Top-Form">
                    <h1 class = "M-TITTL">New Paper Type</h1>      
                </div>

                <div class ="Mid-Form">  <!-- Mid Inp------------------------------------>

                <form action="{{Route('PaperTypes.store')}}" method="POST" enctype="multipart/form-data">
                     @csrf   
                        

                            <div class="field">
                                <label>Paper Type Name</label>
                                <input type="text" name="name" placeholder="Example: Cover, Inside, Common" value="{{old('name')}}" style="@error('name') border: 1px solid red; @enderror" >
