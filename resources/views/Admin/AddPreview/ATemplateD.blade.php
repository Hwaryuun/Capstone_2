    ...
    <div class="main"> <!-- Main------------------------------------>
        ...
        <div class="Add-Holder"> <!-- Add Holder------------------------------------>
            ...
            <div class="Add-InP"> <!-- Add Inp------------------------------------>
                ...
                <div class ="Top-Form">
                    <h1 class = "M-TITTL">Add Templates </h1>      
                </div>
        
               <div class ="Mid-Form">  <!-- Mid Inp------------------------------------>
        
            
                <form action="{{Route('Templates.store',$designs->id )}}" method="POST" enctype="multipart/form-data">
                    @csrf  
                    ...
                    <div class = "EXSepator">  <!-- Mid Seperator------------------------------------>
                        ...
                        <div class = "S1"> <!-- Mid S1------------------------------------>
                            ...
                            <div class="field">
                                <label>Tag</label>
                                <input type="text" name="tag" placeholder="Example: BTM-01" value="{{old('tag')}}" style="@error('tag') border: 1px solid red; @enderror" >
                        ...
                        <div class="BUTNS-BACK">
                            <a class ="Add-ITM-X"  href="{{Route('Templates.index')}}"> <i class="fa-solid fa-right-from-bracket"></i><span> To Templates </span></a> 
                         </div>
