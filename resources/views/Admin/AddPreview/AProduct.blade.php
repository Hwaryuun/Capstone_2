                        ...
                        <div class = "EXSepator"> 
                            ...
                            <div class="field">
                             ...
                             <div class="field">
                                ...
                                <input type="number" max="30" min="0" name="eproduction" placeholder="Example: 3 Working Days" value="{{old('eproduction')}}" style="@error('eproduction') border: 1px solid red; @enderror" >
