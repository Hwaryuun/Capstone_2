    ...
    <div class="main"> <!-- Main------------------------------------>
        ...
        <div class="Add-Holders"> <!-- Add Holder------------------------------------>
            ...
            <div class="Add-InPs"> <!-- Add Inp------------------------------------>
                ...
                <div class ="Top-Form">
                    <h1 class = "M-TITTL">New Pricing Type</h1>      
                </div>

                <div class ="Mid-Form">  <!-- Mid Inp------------------------------------>

                      
                <form action="{{Route('PricingType.store')}}" method="POST" enctype="multipart/form-data" id = "SBMIT">
                    @csrf  
                     ...
                     <!-- Mid Seperator------------------------------------>
                        ...
                        <div class = "S1"> <!-- Mid S1------------------------------------>
                            ...
                            <div class="field">
                                ...
                                <input type="text" name="name" placeholder="Example:  Piece, Box, Reams" value="{{old('name')}}" style="@error('name') border: 1px solid red; @enderror" >
