            ...
            <div class="Add-InP"> <!-- Add Inp------------------------------------>
                ...
                <form action="{{Route('Orders.update', $order->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="samimi">
                        ...
                        <div class="Simsg">
                            <img src="/images/Product_img/{{$order->Products->image}}" alt="">
                        </div>
                        ...
                        <div class="infox">
                            ...
                            <hr>
                            <p class="subaas"> <b>  PRODUCT : </b> {{$order->Products->name}}. </p>
                            <p class="subaas"> <b>  SIZE : </b> {{$order->size}}. </p>
                            <p class="subaas"> <b>  PAPER STOCK : </b> {{$order->paperdefault}}. </p>
                            @if ($order->cover)
                            <p class="subaas"> <b>  PAPER COVER : </b> {{$order->cover}}. </p>
                            <p class="subaas"> <b>  PAGE : </b> {{$order->page}}. </p>
                            @endif
                         
                            <p class="subaas"> <b>  QUANTIY : </b> {{$order->quantity}}.pcs </p>
                            <p class="subaas"> <b>  PRODUCT PRICE : </b>₱ {{ number_format((float)$order->price, 2, ".",",") }}</p>
                            <hr>
                            <p class="subaas"> <b>  CLIENT DESIGN : </b> <a target ="_blank" href="/images/Clientfile_img/{{$order->files}}"> Click Here. </a> </p>
                        </div>
                    </div>
                    ...
                    <div class="azami">
                        ...
                        <div class="yuzaki">
                            ...
                            <div class="fields">
                                ...
                                <p class="subaas"> <b> STATUS : </b>   @if ($order->status == 'In-Progress')
                                ...
                                <p class="subaas"> <b> DATE PLACED : </b> {{$order->created_at->format('F j, Y')}}  <b>  </b> {{$order->created_at->diffForHumans()}}</p>
                    ...
                    <div class = "EXSepator">
                        <div class="BUTNS-AD">                      
                            <a class ="Add-ITM-C"  href="{{Route('Orders.index')}}"> <i class="fa-solid fa-circle-xmark"  ></i> <span> Back </span></a>
                            <button class ="Add-ITM" type="submit"> <i class="fa-solid fa-circle-plus"></i> <span> Update Order </span></button>            
                      </div>
                        <div class="BUTNS-BACK">
                            <a class ="Add-ITM-X"  href="{{Route('PrintPdfr',  $order->id)}}"> <i class="fa-solid fa-print"></i><span> Print Order </span></a> 
                        </div>             
                    </div>
