...
class SpecsExtentions extends Component
{
    public $result = 0;
    public $sizeprice = 0, $paperprice = 0, $paperprice2 = 0,  $quantitty,  $pages = 0;
    public $productiontime, $productname, $prody;
    public $SizeInput,$PaperInput,$PaperInput2,$QuantityInput,$LeafInput;
    public $product_id,$category_id,$papertypes,$service_id;
   // $SizeInput = 0 or ""
    ...
    public function render()
    {
      ...
      //computation live
        ...
        return view('livewire.extentions.specs-extentions',[
            'sizes' => $sizes,
